...
- [x] **SHIP-03**: The owner can verify the deployed HTTPS site, direct project routes, screenshot/resume assets, navigation, and contact links through documented production smoke checks.
- [x] **SHIP-04**: The owner can restore a previous working release using a documented and exercised rollback procedure for the selected host.
