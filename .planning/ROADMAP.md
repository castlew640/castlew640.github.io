...
- [ ] 01-01-PLAN.md — Prove the static profile walking skeleton with a package legitimacy gate and browser-first contract.
...
|-------|----------------|--------|-----------|
| 1. Publishable Portfolio and Delivery | 0/TBD | Not started | - |
