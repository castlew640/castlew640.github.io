...
- [x] 02-03-PLAN.md — Author the four inline architectural drawings, with the reflection motif and both fixed impossible constructions, at every stop.
- [x] 02-04-PLAN.md — Build the pure stop table, the motion policy gate, scroll derivation, hash-arrival focus, and the visible still-view control.

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 02-05-PLAN.md — Build the labelled travel arrows with endpoint semantics and the six-condition tap-versus-swipe discrimination.
...
| 2. One-Handed Surreal Exhibition | 5/8 | In Progress|  |
