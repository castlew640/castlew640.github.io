...
- [x] 02-06-PLAN.md — Stand up the WebGL2 renderer, light rig, scroll-derived camera, ink language, entrance and threshold, demand rendering, and every failure path.
